                              ...
                              <div class="flex flex-wrap -m-2">
                                ...
                                <div class="p-2 w-full">
                                  <div class="relative">
                                    ...
                                    <div class="errors" v-if="errors.kana">{{ errors.kana }}</div>
                                  </div>
                                </div>
                                ...
                                <div class="p-2 w-full">
                                  <div class="relative">
                                    ...
                                    <div class="errors" v-if="errors.tel">{{ errors.tel }}</div>
                                  </div>
                                </div>
                                ...
                                <div class="p-2 w-full">
                                  <div class="relative">
                                    ...
                                    <div class="errors" v-if="errors.postcode">{{ errors.postcode }}</div>
                                  </div>
                                </div>
                                ...
                                <div class="p-2 w-full">
                                  <div class="relative">
                                    ...
                                    <div class="errors" v-if="errors.birthday">{{ errors.birthday }}</div>
                                  </div>
                                </div>
                                ...
                                <div class="p-2 w-full">
                                  <div class="relative">
                                    ...
                                    <div class="errors" v-if="errors.gender">{{ errors.gender }}</div>
                                  </div>
                                </div>
                                ...
                                <div class="p-2 w-full">
                                  <div class="relative">
                                    ...
                                    <div class="errors" v-if="errors.memo">{{ errors.memo }}</div>
                                  </div>
                                </div>

                                <div class="p-2 w-full">
                                  <button class="flex price-auto text-white bg-indigo-500 border-0 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded text-lg">顧客登録</button>
                                </div>
                              </div>
                            </div>
                          </div>
