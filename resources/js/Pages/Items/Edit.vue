                              ...
                              <div class="flex flex-wrap -m-2">
                                ...
                                <div class="p-2 w-full">
                                  <div class="relative">
                                    ...
                                    <div class="errors" v-if="errors.price">{{ errors.price }}</div>
                                  </div>
                                </div>
                                <div class="p-2 w-full">
                                  <div class="relative">
                                    ...
                                    <div class="errors" v-if="errors.is_selling">{{ errors.is_selling }}</div>
                                  </div>
                                </div>
                                <div class="p-2 w-full">
                                  <button class="flex price-auto text-white bg-indigo-500 border-0 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded text-lg">更新する</button>
                                </div>
                              </div>
                            </div>
                          </div>
